 ...
 * WCAG 2.1 ratios that the component set actually renders — focus rings and control borders at 3:1
...
// Reported for the record — a black scrim over a near-black page cannot reach 3:1, so what makes
