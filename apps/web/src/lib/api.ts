...
/**
 * Public demo deployment (`PUBLIC_DEMO_MODE`): the shell shows a banner, every page is `noindex`,
 * and the controls whose procedures the API refuses in demo mode are disabled.
 */
