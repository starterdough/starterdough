<script lang="ts">
	...
	// for the first render. The store is null during SSR, so without the snapshot the section would render as "off"
	// and flip to "on" after hydration: a wrong answer, which is worse than a skeleton.
